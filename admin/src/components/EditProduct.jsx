...
import { Upload, Plus, Star, ListChecks, Pencil, Smartphone, Laptop, Headphones, Package, Info, ChevronDown, Image, Building2, Settings, Trash2, ArrowLeft } from 'lucide-react';
...
const EditProduct = () => {
    ...
    // State to hold images - both existing and new
    ...
    }, [productId, backendUrl, token, navigate]);
    ...
    // Set category name when category changes
    useEffect(() => {
    ...
    const addVariation = () => {
        ...
        setVariations((prev) => [...prev, { ...currentVariation, id: Date.now() }]);
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`${backendUrl}/products/${productId}`, formData, {
                headers: {
    ...
    return (
        <div className="px-4 sm:px-6 py-6 space-y-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
                <h1 className="text-2xl font-bold text-primary"><Title text1={'EDIT'} text2={'PRODUCT'} /></h1>
            ...
            <form onSubmit={onSubmitHandler} className="space-y-8">
                ...
                <div className="bg-bgdark rounded-xl p-4 md:p-6 border border-border shadow-xl">
                    ...
                    {existingImages.length > 0 && (
                        <div className="mb-6">
                            <h3 className="text-sm font-medium text-primary mb-3">Current Images:</h3>
                    ...
                    {/* New Images Upload */}
                    <div>
                        <h3 className="text-sm font-medium text-primary mb-3">Add New Images:</h3>
                    ...
                    <div className="bg-bgdark rounded-xl p-6 border border-border shadow-xl">
                        ...
                        {activeSection === 'variations' && (
                            <div>
                                ...
                                {variations.length > 0 && (
                                    <div className="mt-6">
                                        <h3 className="text-sm font-medium text-primary mb-3">Current Variations:</h3>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <button
                        type="button"
                        onClick={() => navigate('/products')}
                        className="flex-1 font-medium py-3 px-6 rounded-xl border border-border text-secondary hover:text-primary hover:border-accent transition-colors duration-300"
                    >
                        Cancel
                    </button>
                    ...
                    <button
                        ...
                        className={`flex-1 font-medium py-3 px-6 rounded-xl transition-colors duration-300 
            ${isSubmitting
