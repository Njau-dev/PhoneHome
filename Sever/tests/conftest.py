...
from app.models import (
    User, Admin, Category, Brand, Product, Phone, Laptop,
    Cart, CartItem, Order, OrderItem, Address, Payment,
    WishList, Review, Notification, Compare, CompareItem
)
...
def compare_list(db, user, product, multiple_products):
    ...
    item2 = CompareItem(compare_id=compare.id,
                        product_id=multiple_products[0].id)
