...
class BaseConfig:
    ...
    MPESA_BUSINESS_SHORTCODE = os.getenv("MPESA_HEAD_OFFICE_SHORTCODE")
    ...
    # CORS Configuration
    CORS_ORIGINS = parse_cors_origins(os.getenv("CORS_ORIGINS"), FRONTEND_URL)
    CORS_SUPPORTS_CREDENTIALS = True
    CORS_RESOURCES = {
        r"/*": {"origins": CORS_ORIGINS, "supports_credentials": CORS_SUPPORTS_CREDENTIALS}
    }
