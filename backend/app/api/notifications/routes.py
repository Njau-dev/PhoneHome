...
def get_user_notifications():
    ...
    try:
        ...
        return (
            jsonify(format_response(False, None, "An error occurred while fetching notifications")),
            500,
        )
...
def mark_notification_as_read(notification_id):
    ...
    try:
        ...
        return (
            jsonify(
                format_response(
                    True, {"message": "Notification marked as read"}, "Notification marked as read"
                )
            ),
            200,
        )
        ...
        return (
            jsonify(
                format_response(False, None, "An error occurred while marking notification as read")
            ),
            500,
        )
