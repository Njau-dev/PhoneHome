...
def get_product_reviews(product_id):
    ...
    try:
        ...
        # Get reviews
        reviews = (
            Review.query.filter_by(product_id=product_id).order_by(Review.created_at.desc()).all()
        )

        if not reviews:
            return (
                jsonify(
                    format_response(True, {"reviews": []}, "No reviews found for this product")
                ),
                200,
            )
        ...
        return (
            jsonify(
                format_response(True, {"reviews": review_list}, "Reviews fetched successfully")
            ),
            200,
        )
        ...
        return (
            jsonify(format_response(False, None, "An error occurred while fetching reviews")),
            500,
        )
...
def add_review(product_id):
    ...
    try:
        ...
        if existing_review:
            return (
                jsonify(format_response(False, None, "You have already reviewed this product")),
                400,
            )

        # Create review
        new_review = Review(
            user_id=current_user_id, product_id=product_id, rating=rating, comment=comment
        )
        ...
        return (
            jsonify(format_response(False, None, "An error occurred while adding the review")),
            500,
        )
...
def update_review(review_id):
    ...
    try:
        ...
        if str(review.user_id) != current_user_id:
            return (
                jsonify(format_response(False, None, "You can only update your own reviews")),
                403,
            )
        ...
        return (
            jsonify(format_response(False, None, "An error occurred while updating the review")),
            500,
        )
...
def delete_review(review_id):
    ...
    try:
        ...
        if str(review.user_id) != current_user_id:
            return (
                jsonify(format_response(False, None, "You can only delete your own reviews")),
                403,
            )
        ...
        return (
            jsonify(format_response(False, None, "An error occurred while deleting the review")),
            500,
        )
...
def get_my_reviews():
    ...
    try:
        ...
        reviews = (
            Review.query.filter_by(user_id=current_user_id).order_by(Review.created_at.desc()).all()
        )
        ...
        return (
            jsonify(format_response(False, None, "An error occurred while fetching your reviews")),
            500,
        )
