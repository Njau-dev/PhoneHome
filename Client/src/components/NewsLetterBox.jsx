...
const NewsLetterBox = () => {
  ...
  const handleSubscribe = (e) => {
    ...
    //clear inout field after subscription
    setEmail('');
  }
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center  border border-border  rounded-xl p-8 md:p-12 ">
        ...
        <div className="md:w-1/2">
          ...
          <form onSubmit={handleSubscribe} className="relative">
            ...
            {/* Success message */}
            {subscribed && (
              <div className="absolute left-0 -bottom-11 text-green-400 text-sm flex items-center my-4">
        ...
        <div className="md:w-1/2 flex justify-center">
          <div className="relative">
            ...
            <div className="bg-black/20 rounded-xl p-6 relative z-10 border border-border">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="flex gap-2">
                  <span className="bg-border text-accent text-xs py-1 px-2 rounded-full">Tips</span>
                  <span className="bg-border text-accent text-xs py-1 px-2 rounded-full">Offers</span>
                  <span className="bg-border text-accent text-xs py-1 px-2 rounded-full">News</span>
                </div>
              </div>
            </div>
          </div>
